...
SneakX is a modern **full-stack e-commerce web application** built with **React, Tailwind CSS, Firebase Authentication, and Firestore**. It delivers a complete shopping experience with product browsing, product details, wishlist, cart management, checkout, and order history.
